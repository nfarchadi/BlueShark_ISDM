...
##########################################################
# 5 fold cross-validation, repeated 10 times iSDM Constant
##########################################################
source(here("functions", "INLA_constant_skill.r"))

bsh_iSDM_constant <- INLA_constant_skill(dataInput = bsh_all, 
                            inla.x = c(5,6,7),
                            inla.y=1,
                            shp = NWA, 
...
saveRDS(bsh_iSDM_constant, here("bsh_iSDM_constant_results.rds"))