# # repeated k fold cross validation function for constant only ISDM model

INLA_constant_skill <- function(dataInput, inla.x, inla.y, shp, k_folds = 5, repeats = 10, cores = 1, n_samples = 1000){
